...
Abnormal conditions are commonplace in any network-based program. Connections can be destroyed unexpectedly, network packets of arbitrarily strange data can be received, and the complexity of serialization formats can go unnoticed. All of this remains true for the case of HTTP services in Node.js.
