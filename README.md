...
An alternative, more simple solutions exists. In Vapr, routing is performed via a single hash lookup. Parameterized routing (e.g., `/:id`) is performed via a [radix tree](https://en.wikipedia.org/wiki/Radix_tree) lookup.
