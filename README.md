...
Despite the flaws of these benchmarks, to satisfy the curiosity of the reader, benchmark results are shown below comparing Vapr with other popular HTTP frameworks in Node.js.
