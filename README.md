...
For the most part, the core [http](https://nodejs.org/api/http.html) module handles much of the necessary processing of incomming network data. However, there are cases that need to be handled by userland libraries. The examples in this section are not cherry-picked to make Vapr appear artificially more robust, rather, they are a small sample of many sources of common headaches.
