...
> As an advancement from Express, Koa enables the use of late logic, granting significant power to host applications, but with the consequence of requiring rollback logic. Vapr is able to enable late logic without the consequence of rollback logic.
